...
class Card(object):
    ...
    def getRank(self):
        ...
        if self._rank == "A":
            ...
            return (11,) #Formatted in this way because of Ace's values
        elif self._rank == "Q":
            return (12,)
        elif self._rank == "K":
            return (13,)
...
class CardPile(object):
    ...
    #Getters
    def getCards(self):
        """Returns the list of card objects within the cardpile."""
        return self._cards
    ...
    def sendCard(self, dest, old_card_pos = 0, new_card_pos = -1):
        ...
        Cards are sent from the start of self's card list
        to the end of 'dest's' card list by default.
        'dest' must be a cardpile object.
        'old_card_pos' must be an integer reffering to the position of the card to be sent.
        'new_card_pos' must be an integer reffering to the new position of the sent card."""
...
class Deck(CardPile):
    ...
    def deal(self, dest, amount):
        """Sends the given aount of cards to dest's card list.
        'dest' must be a cardpile object.
